import { AuthAction, AuthState, AuthActionTypes } from "../../types/aythTypes"
...
export const authReducer = (state = initialState, action: AuthAction): AuthState => {
    switch (action.type) {
        ...
        case AuthActionTypes.FETCH_AUTH_ERROR:
            return {isLoading: false, error: action.payload, isAuth: true, user: {refreshToken: "", accessToken: "", user: { email: "", isActivated: false, id: -1 }}}
        default:
            return state
    }        
}