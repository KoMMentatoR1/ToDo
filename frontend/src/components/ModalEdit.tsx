      ...
      >
        <Box className='modalEdit'>
          ...
          <div className='EditButtonContainer'>
            <Button sx={{width: "49%"}} variant="contained" color="success" onClick={() => clickSuccess()}>Изменить</Button>
            <Button sx={{width: "49%"}} variant="contained" color="error" onClick={() => onClose()}>Отменить</Button>
          </div>
        </Box>
      </Modal>  
    </div>
